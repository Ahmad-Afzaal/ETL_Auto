...
# DBX Parms
#-----------
dbutils.widgets.text('s3_location', 's3://gia-stg-oh-ue1-data-raw/haven/haven/inbound/VE_EDW')  
...
# EDW Staging Tables
#-------------------
dbutils.widgets.text('EDW_CtlLog_tmp', 'EDW_CtlLog_Recip_tmp')
...
s3_location_final = f"{s3_location}{received_date}/*.RECIPIENT.WEEKLY.*.ctl" 
