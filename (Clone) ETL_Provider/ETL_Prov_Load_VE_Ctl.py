...
dbutils.widgets.text('received_date', '2024-04-02')  
...
# EDW Staging Tables
#-------------------
dbutils.widgets.text('EDW_CtlLog_tmp', 'EDW_CtlLog_Prov_tmp')
...
s3_location_final = f"{s3_location}{received_date}/*.PROVIDER.WEEKLY.*.ctl" 
