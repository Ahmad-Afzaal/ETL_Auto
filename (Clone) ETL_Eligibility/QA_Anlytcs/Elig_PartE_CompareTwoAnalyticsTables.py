...
#************************************************************************************************************************************
#*                                                                                                                                  *
#*   NOTEBOOK:     Elig_PartE_CompareTwoAnalyticsTables.                                                                            *
#*                                                                                                                                  *
#*   DESCRIPTION:                                                                                                                   *
#*                                                                                                                                  *
#*                                                                                                                                  *
...
dbutils.widgets.text('DiffAnlysTblNm', 'EligAnlytcs_Part_E_DiffAnlys')
...
# MAGIC     ,COALESCE(PrevTbl.E_DTE_EFFECTIVE, CurntTbl.E_DTE_EFFECTIVE) AS E_DTE_EFFECTIVE -- This is the common identifier
...
# MAGIC     ,CASE WHEN PrevTbl.E_DTE_END                 != CurntTbl.E_DTE_END                 THEN PrevTbl.E_DTE_END                 ELSE NULL END AS CurntTbl_E_DTE_END                               
# MAGIC     ,CASE WHEN PrevTbl.E_DTE_END                 != CurntTbl.E_DTE_END                 THEN CurntTbl.E_DTE_END                ELSE NULL END AS PrevTbl_E_DTE_END                               
# MAGIC     ,CASE WHEN PrevTbl.E_ID_PROVIDER_MCAID          != CurntTbl.E_ID_PROVIDER_MCAID          THEN PrevTbl.E_ID_PROVIDER_MCAID          ELSE NULL END AS CurntTbl_E_ID_PROVIDER_MCAID
# MAGIC     ,CASE WHEN PrevTbl.E_ID_PROVIDER_MCAID          != CurntTbl.E_ID_PROVIDER_MCAID          THEN CurntTbl.E_ID_PROVIDER_MCAID         ELSE NULL END AS PrevTbl_E_ID_PROVIDER_MCAID
...
# MAGIC                                                                            AND PrevTbl.E_DTE_EFFECTIVE = CurntTbl.E_DTE_EFFECTIVE
# MAGIC WHERE 
# MAGIC        PrevTbl.NUM_CASE                  != CurntTbl.NUM_CASE                  
# MAGIC     OR PrevTbl.Derived2                  != CurntTbl.Derived2                     
# MAGIC     OR PrevTbl.E_DTE_END                 != CurntTbl.E_DTE_END                
# MAGIC     OR PrevTbl.E_ID_PROVIDER_MCAID          != CurntTbl.E_ID_PROVIDER_MCAID
# MAGIC    AND PrevTbl.E_DTE_EFFECTIVE is not null
# MAGIC ;
...
# MAGIC   ),
# MAGIC   Cnt_E_DTE_END AS (
# MAGIC     SELECT COUNT(*) AS Diff_E_DTE_END
# MAGIC     FROM ${catalog}.${schema_name}.${DiffAnlysTblNm}
# MAGIC     WHERE CurntTbl_E_DTE_END IS NOT NULL
# MAGIC        OR PrevTbl_E_DTE_END IS NOT NULL
# MAGIC   ),
# MAGIC   Cnt_E_ID_PROVIDER_MCAID AS (
# MAGIC     SELECT COUNT(*) AS Diff_E_ID_PROVIDER_MCAID
# MAGIC     FROM ${catalog}.${schema_name}.${DiffAnlysTblNm}
# MAGIC     WHERE CurntTbl_E_ID_PROVIDER_MCAID IS NOT NULL
# MAGIC        OR PrevTbl_E_ID_PROVIDER_MCAID IS NOT NULL
# MAGIC   )
# MAGIC
# MAGIC SELECT
# MAGIC   format_number(t5.cntTotal, 0)                             AS cntTotal,
# MAGIC   format_number(t1.Diff_Derived2, 0)                        AS Diff_Derived2,
# MAGIC   format_number(CASE WHEN t5.cntTotal = 0 THEN 0
# MAGIC                   ELSE t1.Diff_Derived2 * 100 / t5.cntTotal
# MAGIC              END, '###.#')                                  AS Pcntg_Derived2,
# MAGIC   format_number(t2.Diff_NUM_CASE, 0)                        AS Diff_NUM_CASE,
# MAGIC   format_number(CASE WHEN t5.cntTotal = 0 THEN 0
# MAGIC                   ELSE t2.Diff_NUM_CASE * 100 / t5.cntTotal
# MAGIC              END, '###.#')                                  AS Pcntg_NUM_CASE,
# MAGIC   format_number(t3.Diff_E_DTE_END, 0)                       AS Diff_E_DTE_END,
# MAGIC   format_number(CASE WHEN t5.cntTotal = 0 THEN 0
# MAGIC                   ELSE t3.Diff_E_DTE_END * 100 / t5.cntTotal
# MAGIC              END, '###.#')                                  AS Pcntg_E_DTE_END,
# MAGIC   format_number(t4.Diff_E_ID_PROVIDER_MCAID, 0)                AS Diff_E_ID_PROVIDER_MCAID,
# MAGIC   format_number(CASE WHEN t5.cntTotal = 0 THEN 0
# MAGIC                   ELSE t4.Diff_E_ID_PROVIDER_MCAID * 100 / t5.cntTotal
# MAGIC              END, '###.#')                                  AS Pcntg_E_ID_PROVIDER_MCAID
# MAGIC FROM
# MAGIC   Cnt_Derived2 t1,
# MAGIC   Cnt_NUM_CASE t2,
# MAGIC   Cnt_E_DTE_END t3,
# MAGIC   Cnt_E_ID_PROVIDER_MCAID t4,
# MAGIC   Sum_Total t5
# MAGIC ;
...
# MAGIC     FROM ${catalog}.${schema_name}.${CurntTblNm} CurntTbl
# MAGIC     WHERE TRUE
# MAGIC       AND CurntTbl.E_DTE_EFFECTIVE is not null
...
# MAGIC            AND CurntTbl.E_DTE_EFFECTIVE = t1.E_DTE_EFFECTIVE
# MAGIC        )
# MAGIC   ),
...
# MAGIC            AND PrevTbl.E_DTE_EFFECTIVE = t4.E_DTE_EFFECTIVE
# MAGIC        )
# MAGIC   )
