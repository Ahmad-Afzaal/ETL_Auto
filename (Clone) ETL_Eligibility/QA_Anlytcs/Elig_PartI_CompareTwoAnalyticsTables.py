...
# MAGIC     ,CASE WHEN PrevTbl.I_DTE_END                 != CurntTbl.I_DTE_END                 THEN PrevTbl.I_DTE_END                 ELSE NULL END AS PrevTbl_I_DTE_END
# MAGIC     ,CASE WHEN PrevTbl.I_DTE_END                 != CurntTbl.I_DTE_END                 THEN CurntTbl.I_DTE_END                ELSE NULL END AS CurntTbl_I_DTE_END
