...
#************************************************************************************************************************************
#*                                                                                                                                  *
#*   NOTEBOOK:     Elig_PartN_CompareTwoAnalyticsTables.                                                                            *
#*                                                                                                                                  *
#*   DESCRIPTION:                                                                                                                   *
#*                                                                                                                                  *
#*                                                                                                                                  *
...
dbutils.widgets.text('DiffAnlysTblNm', 'EligAnlytcs_Part_N_DiffAnlys')
...
# MAGIC     ,COALESCE(PrevTbl.N_DTE_TPL_EFFECTIVE, CurntTbl.N_DTE_TPL_EFFECTIVE) AS N_DTE_TPL_EFFECTIVE -- This is the common identifier
...
# MAGIC     ,CASE WHEN PrevTbl.N_DTE_TPL_END             != CurntTbl.N_DTE_TPL_END             THEN PrevTbl.N_DTE_TPL_END             ELSE NULL END AS PrevTbl_N_DTE_TPL_END
# MAGIC     ,CASE WHEN PrevTbl.N_DTE_TPL_END             != CurntTbl.N_DTE_TPL_END             THEN CurntTbl.N_DTE_TPL_END            ELSE NULL END AS CurntTbl_N_DTE_TPL_END
...
# MAGIC                                                               AND PrevTbl.N_DTE_TPL_EFFECTIVE = CurntTbl.N_DTE_TPL_EFFECTIVE
# MAGIC WHERE 
# MAGIC        PrevTbl.NUM_CASE                  != CurntTbl.NUM_CASE                  
# MAGIC     OR PrevTbl.Derived2                  != CurntTbl.Derived2                     
# MAGIC     OR PrevTbl.N_DTE_TPL_END                 != CurntTbl.N_DTE_TPL_END                
# MAGIC    AND PrevTbl.N_DTE_TPL_EFFECTIVE is not null
# MAGIC ;
...
# MAGIC   ),
# MAGIC   Cnt_N_DTE_TPL_END AS (
# MAGIC     SELECT COUNT(*) AS Diff_N_DTE_TPL_END
# MAGIC     FROM ${catalog}.${schema_name}.${DiffAnlysTblNm}
# MAGIC     WHERE CurntTbl_N_DTE_TPL_END IS NOT NULL
# MAGIC        OR PrevTbl_N_DTE_TPL_END IS NOT NULL
# MAGIC   )
# MAGIC
# MAGIC SELECT
# MAGIC   format_number(t1.Diff_Derived2, 0)                        AS Diff_Derived2,
# MAGIC   format_number(CASE WHEN t4.cntTotal = 0 THEN 0
# MAGIC                   ELSE t1.Diff_Derived2 * 100 / t4.cntTotal
# MAGIC              END, '###.#')                                  AS Pcntg_Derived2,
# MAGIC   format_number(t2.Diff_NUM_CASE, 0)                        AS Diff_NUM_CASE,
# MAGIC   format_number(CASE WHEN t4.cntTotal = 0 THEN 0
# MAGIC                   ELSE t2.Diff_NUM_CASE * 100 / t4.cntTotal
# MAGIC              END, '###.#')                                  AS Pcntg_NUM_CASE,
# MAGIC   format_number(t3.Diff_N_DTE_TPL_END, 0)                       AS Diff_N_DTE_TPL_END,
# MAGIC   format_number(CASE WHEN t4.cntTotal = 0 THEN 0
# MAGIC                   ELSE t3.Diff_N_DTE_TPL_END * 100 / t4.cntTotal
# MAGIC              END, '###.#')                                  AS Pcntg_N_DTE_TPL_END,
# MAGIC   format_number(t4.cntTotal, 0)                             AS cntTotal
# MAGIC FROM
# MAGIC   Cnt_Derived2 t1,
# MAGIC   Cnt_NUM_CASE t2,
# MAGIC   Cnt_N_DTE_TPL_END t3,
# MAGIC   Sum_Total t4
# MAGIC ;
...
# MAGIC                    ,PrevTbl.N_DTE_TPL_EFFECTIVE 
# MAGIC           FROM ${catalog}.${schema_name}.${CurntTblNm} CurntTbl
...
# MAGIC     FROM ${catalog}.${schema_name}.${CurntTblNm} CurntTbl
# MAGIC     WHERE TRUE
# MAGIC       AND CurntTbl.N_DTE_TPL_EFFECTIVE is not null
...
# MAGIC            AND CurntTbl.N_DTE_TPL_EFFECTIVE = t1.N_DTE_TPL_EFFECTIVE
# MAGIC        )
# MAGIC   ),
...
# MAGIC            AND PrevTbl.N_DTE_TPL_EFFECTIVE = t4.N_DTE_TPL_EFFECTIVE
# MAGIC        )
# MAGIC   )
