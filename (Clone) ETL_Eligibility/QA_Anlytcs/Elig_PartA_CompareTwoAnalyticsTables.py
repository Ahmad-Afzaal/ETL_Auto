...
#************************************************************************************************************************************
#*                                                                                                                                  *
#*   NOTEBOOK:     Elig_PartA_CompareTwoAnalyticsTables.                                                                            *
#*                                                                                                                                  *
#*   DESCRIPTION:                                                                                                                   *
#*                                                                                                                                  *
#*                                                                                                                                  *
...
dbutils.widgets.text('DiffAnlysTblNm', 'EligAnlytcs_Part_A_DiffAnlys')
...
# MAGIC     OR PrevTbl.A_DTE_END                 != CurntTbl.A_DTE_END                
# MAGIC     OR PrevTbl.CDE_STATUS                != CurntTbl.CDE_STATUS
# MAGIC    AND PrevTbl.A_DTE_EFFECTIVE is not null
# MAGIC ;
...
# MAGIC   ),
# MAGIC   Cnt_A_DTE_END AS (
# MAGIC     SELECT COUNT(*) AS Diff_A_DTE_END
# MAGIC     FROM ${catalog}.${schema_name}.${DiffAnlysTblNm}
# MAGIC     WHERE CurntTbl_A_DTE_END IS NOT NULL
# MAGIC        OR PrevTbl_A_DTE_END IS NOT NULL
# MAGIC   ),
# MAGIC   Cnt_CDE_STATUS AS (
# MAGIC     SELECT COUNT(*) AS Diff_CDE_STATUS
# MAGIC     FROM ${catalog}.${schema_name}.${DiffAnlysTblNm}
# MAGIC     WHERE CurntTbl_CDE_STATUS IS NOT NULL
# MAGIC        OR PrevTbl_CDE_STATUS IS NOT NULL
# MAGIC   )
# MAGIC
# MAGIC SELECT
...
# MAGIC   format_number(t3.Diff_A_DTE_END, 0)                       AS Diff_A_DTE_END,
# MAGIC   format_number(CASE WHEN t5.cntTotal = 0 THEN 0
# MAGIC                   ELSE t3.Diff_A_DTE_END * 100 / t5.cntTotal
# MAGIC              END, '###.#')                                  AS Pcntg_A_DTE_END,
# MAGIC   format_number(t4.Diff_CDE_STATUS, 0)                AS Diff_CDE_STATUS,
# MAGIC   format_number(CASE WHEN t5.cntTotal = 0 THEN 0
# MAGIC                   ELSE t4.Diff_CDE_STATUS * 100 / t5.cntTotal
# MAGIC              END, '###.#')                                  AS Pcntg_CDE_STATUS,
# MAGIC   format_number(t5.cntTotal, 0)                             AS cntTotal
# MAGIC FROM
# MAGIC   Cnt_Derived2 t1,
# MAGIC   Cnt_NUM_CASE t2,
# MAGIC   Cnt_A_DTE_END t3,
# MAGIC   Cnt_CDE_STATUS t4,
# MAGIC   Sum_Total t5
# MAGIC ;
...
# MAGIC     FROM ${catalog}.${schema_name}.${CurntTblNm} CurntTbl
# MAGIC     WHERE TRUE
# MAGIC       AND CurntTbl.A_DTE_EFFECTIVE is not null
...
# MAGIC            AND CurntTbl.A_DTE_EFFECTIVE = t1.A_DTE_EFFECTIVE
# MAGIC        )
# MAGIC   ),
...
# MAGIC            AND PrevTbl.A_DTE_EFFECTIVE = t4.A_DTE_EFFECTIVE
# MAGIC        )
# MAGIC   )
