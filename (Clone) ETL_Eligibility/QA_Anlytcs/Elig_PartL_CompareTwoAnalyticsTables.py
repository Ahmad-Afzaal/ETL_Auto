...
# MAGIC     ,CASE WHEN PrevTbl.L_DTE_END                 != CurntTbl.L_DTE_END                 THEN PrevTbl.L_DTE_END                 ELSE NULL END AS PrevTbl_L_DTE_END
# MAGIC     ,CASE WHEN PrevTbl.L_DTE_END                 != CurntTbl.L_DTE_END                 THEN CurntTbl.L_DTE_END                ELSE NULL END AS CurntTbl_L_DTE_END
