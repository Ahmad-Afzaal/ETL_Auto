...
#************************************************************************************************************************************
#*                                                                                                                                  *
#*   NOTEBOOK:     ETL_Eligibility_Load_VE_Ctl.                                                                                       *
#*                                                                                                                                  *
#*   DESCRIPTION:                                                                                                                   *
#*                                                                                                                                  *
#*                                                                                                                                  *
...
dbutils.widgets.text('VEN101', 'VEN101FA')
...
FileMask = dbutils.widgets.get('FileMask')
VEN116 = dbutils.widgets.get('VEN116')
VEN101 = dbutils.widgets.get('VEN101')
...
s3_location_final = f"{s3_location}{received_date}/{FileMask}" 
...
# MAGIC select 
# MAGIC  CASE WHEN split_part(FileNm,'.' ,3) = "${VEN116}" THEN split_part(FileNm,'.' ,7)||split_part(split_part(FileNm,'.' ,8),'_',1) ELSE split_part(FileNm,'.' ,3) END,
# MAGIC  CASE WHEN split_part(FileNm,'.' ,3) = "${VEN116}" THEN split_part(FileNm,'.' ,9)
# MAGIC       WHEN split_part(FileNm,'.' ,3) = "${VEN101}" THEN split_part(FileNm,'.' ,8)
# MAGIC       ELSE split_part(FileNm,'.' ,7) END,
# MAGIC  * 
