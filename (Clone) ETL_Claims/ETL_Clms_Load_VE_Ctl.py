...
dbutils.widgets.text('received_date', '2024-06-14')  
...
# EDW Staging Tables
#-------------------
dbutils.widgets.text('EDW_CtlLog_tmp', 'EDW_CtlLog_Clms_tmp')
...
s3_location_final = f"{s3_location}{received_date}/*.CLAIMS.WEEKLY.*.ctl" 
...
# DBTITLE 1,Drop Temporary Table
# MAGIC %sql
