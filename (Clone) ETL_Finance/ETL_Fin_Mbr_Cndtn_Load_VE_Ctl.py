...
#************************************************************************************************************************************
#*                                                                                                                                  *
#*   NOTEBOOK:     ETL_Fin_Mbr_Cndtn_Load_VE_Ctl.                                                                                   *
#*                                                                                                                                  *
#*   DESCRIPTION:                                                                                                                   *
#*                                                                                                                                  *
#*                                                                                                                                  *
...
dbutils.widgets.text('FileMask', '*.CAPITATION.MONTHLY.*.ctl')

#-------------------
# EDW Staging Tables
#-------------------
dbutils.widgets.text('EDW_CtlLog_tmp', 'EDW_CtlLog_FinMbrCndtn_tmp')
dbutils.widgets.text('EDW_CtlLog', 'EDW_CtlLog_FinMbrCndtn_Staging')
